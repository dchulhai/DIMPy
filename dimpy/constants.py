...
ANGSTROM2CM   = Conversion(1.0 / CM2ANGSTROM)
...
# The elements! ELEMENTS can be indexed (i.e. ELEMENTS[6] returns 'C')
# and elemset can be quickly searched ('Be' in elemset)
ELEMENTS = ( 'Xx', 'H',  'He', 'Li', 'Be', 'B',  'C',  'N',  'O',  'F',  'Ne',
